...
@register_model('slide-coattention-masked-latent-idiom-with-gate')
class SlideCoAttentionMaskedLatentIdiomWithGate(BertPreTrainedModel):
...
@register_model('slide-coattention-masked-full-latent-idiom')
class SlideCoAttentionMaskedFullLatentIdiom(BertPreTrainedModel):
